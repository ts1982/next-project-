...
```env
DATABASE_URL="postgresql://nextuser:nextpassword@localhost:5432/nextdb?schema=public"
...
make db-restart       # PostgreSQLコンテナ再起動
make db-logs          # PostgreSQLログ表示
make db-shell         # PostgreSQLシェル起動
```
